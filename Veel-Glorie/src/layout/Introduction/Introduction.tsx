...
function Introduction(): JSX.Element {
  return (
    <Section transparency background="secondary" separation={separations.BIG_DOUBLE}>
      <div className="flex border-4 rounded-md border-primary border-color-primary border-[primary] border-color-primary border-red">
        <YouTube title="Video gremial" url="ix-pyuUBMlE?si=h_nDnFwrtVFoUI3O" />
      </div>
      <div className="flex flex-col text-center max-w[35rem]">
        <p>
